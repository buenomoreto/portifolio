      ...
      <Section className='row'>
        <div className='desktop'>
          <p className='paragraph'>
            Apaixonado por <strong className='emphasis'>programação</strong> desde cedo, encontrei minha vocação como desenvolvedor web e tenho <strong className='emphasis'>habilidades</strong> em criar uma variedade de sites, blogs e lojas online. Sou especialmente experiente em <strong className='emphasis'>Vue.js</strong> e tenho a <strong className='emphasis'>habilidade</strong> de construir interfaces de usuário elegantes e responsivas. Além disso, também gosto de explorar outras tecnologias, como React Native, e estou sempre buscando expandir minhas <strong className='emphasis'>habilidades</strong> e conhecimentos em <strong className='emphasis'>programação</strong>. 
          </p>
          <p className='paragraph'>
